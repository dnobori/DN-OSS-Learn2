...
BEGIN {
    ...
    require 'C:/git/SE-Build-crosslib_win32_v2/OpenSSL/src/build/vc2017/x64_Debug/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = 'C:/git/SE-Build-crosslib_win32_v2/OpenSSL/src/build/vc2017/x64_Debug/test/fips-and-base.cnf';
    shift;
